 ...
 */
public class IngestionHdfsIT {

    private final static Logger logger = Logger.getLogger("org.uk.aeb.IngestionHdfsIT");

    private static final String CONFIG_PATH = "";
    private static final String APPLICATION_CONFIG_FILE = "application_hdfs.properties";
